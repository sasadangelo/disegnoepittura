...
Nell’articolo sulla [percezione dello spazio]({{ site.baseurl }}/percezione-spazio/ "Percezione dello Spazio") abbiamo compreso come linee convergenti verso un punto danno un senso di profondità. Il prossimo passo è quello di comprendere i principi base della [prospettiva]({{ site.baseurl }}/composizione-prospettiva/ "Prospettiva").
...
![Piano Frontale]({{ site.baseurl }}/wp-content/uploads/prospettiva-centrale-1.png "Piano Frontale")

Facciamo convergere tutti i vertici verso il punto focale centrale.

![Linee Prospettiche]({{ site.baseurl }}/wp-content/uploads/prospettiva-centrale-2.png "Linee Prospettiche")
...
![Calcolo Profondità Cubo]({{ site.baseurl }}/wp-content/uploads/prospettiva-centrale-3.png "Calcolo Profondità Cubo")

Uniamo i punti fin qui ottenuti per ottenere il nostro cubo.

![Cubo in Prospettiva Centrale]({{ site.baseurl }}/wp-content/uploads/prospettiva-centrale-4.png "Cubo in Prospettiva Centrale")
...
![Cubo in Prospettiva Centrale]({{ site.baseurl }}/wp-content/uploads/prospettiva-centrale-5.png "Cubi in Prospettiva Centrale")
