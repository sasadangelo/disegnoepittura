...
La [campitura](https://it.wiktionary.org/wiki/campitura "Campitura") è la stesura di uno strato di colore uniforme sulla tela da eseguire prima d’iniziare a dipingere. Essa passando attraverso il dipinto, crea un effetto ottico che, in base al modo con cui si sceglie di realizzarlo, può renderlo:
...
Quando il disegno è realizzato direttamente con il pennello allora conviene eseguire prima la campitura. Nel mio caso, eseguo prima il [disegno a matita, poi ripasso con l’inchiostro di china](/come-disegnare-soggetto-dipinto/) e solo successivamente realizzo la campitura.
...
Per mostrare come eseguo una campitura partiamo dalla tela su cui ho già [eseguito il disegno a mano libera ripassato poi con inchiostro di china](/come-disegnare-soggetto-dipinto/).
